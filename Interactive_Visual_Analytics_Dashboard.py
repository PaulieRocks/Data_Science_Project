...
def get_graph(chart, year, children1, children2, c3, c4, c5):
    ...
    if chart == 'OPT1':
        ...
        # Number of flights u  nder different cancellation categories
        ...
        line_fig = px.line(line_data, x='Reporting_Airline', y='AirTime', title='Average flight time by reporting airline')
        ...
        # Enter your code below. Make sure you have correct formatting.
        tree_fig = px.treemap(tree_data, path=['DestState','Reporting_Airline'], values='Flights', title="Number of flights flying to each state from each reporting airline")
